# Clickgate WordPres Plugin
![Version](https://img.shields.io/badge/version-v1.0.0-violet.svg)
![Last commit](https://img.shields.io/github/last-commit/wysiwyg-software-design/clickgate.svg?style=flat)
![Build status](https://api.travis-ci.org/wysiwyg-software-design/clickgate.svg?branch=develop)
...
| Endpoint              | URL                                   |
|---------              | ---                                   |
| Frontend              | http://clickgate.local                  |
| Backend               | http://clickgate.local/wp-admin         |
| phpMyAdmin            | http://clickgate.local/phpmyadmin       |
|                       |                                       |
| **Docker** Frontend   | http://clickgate.localhost              |
| **Docker** Backend    | http://clickgate.localhost/wp-admin     |
| **Docker** phpMyAdmin | http://clickgate.localhost/phpmyadmin   |
